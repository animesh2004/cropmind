...
import { User, Globe, Radio } from "lucide-react"
        ...
        >
          ...
          <div className="text-left min-w-0 hidden sm:block">
            ...
            <p className="text-xs text-muted-foreground truncate">
              {typeof window !== "undefined" && getActiveNode() 
                ? `${getActiveNode()?.name} Active` 
                : "No Active Node"}
            </p>
          </div>
        ...
        <div className="space-y-4 py-4 overflow-y-auto flex-1 pr-2">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Manage multiple IoT nodes and switch between them. The active node will be used for all sensor readings.
            </p>
          </div>
